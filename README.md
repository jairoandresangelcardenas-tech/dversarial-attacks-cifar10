...
|---|---|---|---|---|---|
| ResNet-18 estándar | 93.42% | 17.66% | 0.00% | 0.00% | 0.00% |
...
Los adversarios transfieren parcialmente (SimpleCNN limpia: 84.41%), evidencia de *non-robust features*.
